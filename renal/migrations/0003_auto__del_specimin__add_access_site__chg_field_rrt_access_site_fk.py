...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'renal_specimin')

        # Adding model 'Access_site'
        db.create_table(u'renal_access_site', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
        ))
        db.send_create_signal(u'renal', ['Access_site'])


        # Changing field 'RRT.access_site_fk'
        db.alter_column(u'renal_rrt', 'access_site_fk_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['renal.Access_site'], null=True))

    def backwards(self, orm):
        # Adding model 'Specimin'
        db.create_table(u'renal_specimin', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255, unique=True)),
        ))
        db.send_create_signal(u'renal', ['Specimin'])

        # Deleting model 'Access_site'
        db.delete_table(u'renal_access_site')


        # Changing field 'RRT.access_site_fk'
        db.alter_column(u'renal_rrt', 'access_site_fk_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['renal.Specimin'], null=True))
