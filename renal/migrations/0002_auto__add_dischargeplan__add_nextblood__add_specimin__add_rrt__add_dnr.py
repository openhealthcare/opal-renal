...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DischargePlan'
        db.create_table(u'renal_dischargeplan', (
            ...
            ('date_of_discharge', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('date_of_medical_fitness', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('date_of_outpatient_appt', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('outpatient_tests', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'renal', ['DischargePlan'])

        # Adding model 'NextBlood'
        db.create_table(u'renal_nextblood', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('consistency_token', self.gf('django.db.models.fields.CharField')(max_length=8)),
            ('episode', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['opal.Episode'], null=True)),
        ...
        db.send_create_signal(u'renal', ['NextBlood'])
        ...
        # Adding model 'RRT'
        db.create_table(u'renal_rrt', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('consistency_token', self.gf('django.db.models.fields.CharField')(max_length=8)),
            ('episode', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['opal.Episode'], null=True)),
            ('haemodialysis', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('peritonealdialysis', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('no_rrt', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('transplant', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('donor_type', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('access_site_fk', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['renal.Specimin'], null=True, blank=True)),
            ('access_site_ft', self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True)),
        ))
        db.send_create_signal(u'renal', ['RRT'])

        # Adding model 'DNR'
        db.create_table(u'renal_dnr', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('consistency_token', self.gf('django.db.models.fields.CharField')(max_length=8)),
            ('episode', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['opal.Episode'], null=True)),
            ('dnr', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
        ))
        db.send_create_signal(u'renal', ['DNR'])


    def backwards(self, orm):
        # Deleting model 'DischargePlan'
        db.delete_table(u'renal_dischargeplan')

        # Deleting model 'NextBlood'
        db.delete_table(u'renal_nextblood')

        # Deleting model 'Specimin'
        db.delete_table(u'renal_specimin')

        # Deleting model 'RRT'
        db.delete_table(u'renal_rrt')

        # Deleting model 'DNR'
        db.delete_table(u'renal_dnr')
    ...
    models = {
        ...
        u'renal.rrt': {
            ...
            'access_site_fk': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['renal.Specimin']", 'null': 'True', 'blank': 'True'}),
