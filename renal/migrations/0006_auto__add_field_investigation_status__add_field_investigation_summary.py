...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Investigation.status'
        db.add_column(u'renal_investigation', 'status',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Investigation.summary'
        db.add_column(u'renal_investigation', 'summary',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Investigation.status'
        db.delete_column(u'renal_investigation', 'status')

        # Deleting field 'Investigation.summary'
        db.delete_column(u'renal_investigation', 'summary')
